...
import { useIsMobile } from "@/old/hooks/use-mobile";
...
import { Sheet, SheetContent } from "@/old/components/ui/sheet";
import { Skeleton } from "@/old/components/ui/skeleton";
import {
  Tooltip,
  TooltipContent,
  TooltipProvider,
  TooltipTrigger,
} from "@/old/components/ui/tooltip";
...
const SidebarTrigger = React.forwardRef(
  ({ className, onClick, ...props }, ref) => {
    ...
    return (
      ...
      >
        <ChevronLeft
          className="transition duration-175 ease-in-out hidden md:block"
