...
import { Textarea } from "@/old/components/ui/textarea";
          ...
          return (
            ...
            >
              ...
              <div className="flex gap-4">
                ...
                {index !== 0 && (
                  <span className="w-7 h-7 flex justify-center align-middle bg-zinc-200 hover:bg-zinc-300 cursor-pointer rounded-md">
                    <ArrowUpFromLine
