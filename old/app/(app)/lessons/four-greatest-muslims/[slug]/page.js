...
export default async function LessonPage({ params }) {
  ...
  const vidSrc =
    slug === "abu-bakr"
      ? "https://www.youtube.com/embed/eFmilF9QwO8?si=skMywqQqnTsEGBdg"
      : slug === "umar"
        ? "https://www.youtube.com/embed/hzvLA4VE-tc?si=AyH8FDDC6e6yycYI"
        : slug === "uthman"
          ? "https://www.youtube.com/embed/yjOlOrBhs70?si=NnlR5RoreXwBP3xZ"
          : slug === "ali" &&
            "https://www.youtube.com/embed/PLEt4cJRjw8?si=K1LLIeKzq68yLA0l";
    ...
    <>
      ...
      <section className="my-8 max-w-[1024px] mx-auto w-[100vw] px-8">
        <Button
          href={nextSession}
          colour={`purple`}
          className={`${!nextSession && "hidden"} text-sm md:text-md float-right`}
        >
          Next Session
        </Button>
        <Button
          ...
          colour={`purple`}
          back={true}
          className={`${!prevSession && "hidden"} text-sm md:text-md float-left max-w-[820px]`}
        >
          Previous Session
        </Button>
      </section>
