...
function Book({ title, href, image, ...props }) {
  return (
    <div
      className={`${styles.book} w-[250px] h-[312px] smd:w-[200px] smd:h-[250px] bg-blue relative mb-12 book transition-all duration-200`}
    >
      <Link href={href}>
        <Image
  ...
  return (
    <>
      <div className="absolute left-0 top-0 w-screen min-h-[525px] h-[calc(40vh+244px)] z-[-1] bg-[rgb(240,162,41,0.5)]">
        ...
        <Image
          src={
            "//wsrv.nl/?url=almasjid-site.s3.eu-north-1.amazonaws.com/books.jpg&w=500&h=400"
          }
          unoptimized
