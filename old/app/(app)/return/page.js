...
const handsImg =
  "https://almasjid-site.s3.eu-north-1.amazonaws.com/charity.png";
...
export default function Return({}) {
  ...
  useEffect(() => {
    ...
    fetch(
      `/api/checkout_sessions?payment_intent=${paymentIntent}&secret=${secret}`,
      {
        method: "GET",
      },
    )
      ...
      <Container>
        ...
        >
          ...
          <div className="w-full md:w-[50%] my-auto">
            <Heading className="mb-4 md:text-6xl">
