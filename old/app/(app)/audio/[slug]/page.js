...
import TracksRender from "@/old/app/ui/audioPlayer/tracks/TrackRender";
import { notFound } from "next/navigation";
import {
  PlayButtonMobile,
  PlayButttonDesktop,
} from "@/old/app/ui/audioPlayer/tracks/playButton/playButton";
    ...
    <>
      <div className="container mx-auto px-4 py-8 max-w-5xl font-[family-name:var(--font-montserrat)] mb-[15vh]">
        ...
        <div className="max-w-[80vw] mx-auto ">
          <Link
            href="/audio"
            className="inline-flex items-center mb-4 text-md font-medium text-primary hover:text-primary/80"
          >
            <svg
        ...
        <div className="flex flex-col md:flex-row gap-8 mb-8 max-w-[80vw] mx-auto">
          ...
          <div className="flex flex-col gap-4 justify-around">
            <div>
              <ViewTransition
                name={`album-title-${album.title.toLowerCase().replace(/ /g, "-").replace(/'/g, "")}`}
              >
              ...
              {album.descriptionUrdu && (
                <p className="text-foreground mb-2 text-right font-[family-name:var(--font-nastaliq)] leading-10">
                  {album.descriptionUrdu}
                </p>
              )}
