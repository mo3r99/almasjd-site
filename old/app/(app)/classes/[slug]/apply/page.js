...
export default async function ApplyPage({ params }) {
  ...
  switch (whichClass) {
    ...
    case "hygiene":
      ...
      iframeUrl =
        "https://forms.office.com/Pages/ResponsePage.aspx?id=ZOrjoRGHW0a27251DWrQb7SjwJ0Q6f1Dm73UP8eB77pUN1Q2SkxaN1FRUUNNM1hVTkQ5VTc1N0haMC4u&embed=true";
      break;
    case "female-hygiene":
    ...
    case "tafseer-surahs":
      ...
      iframeUrl =
        "https://forms.office.com/Pages/ResponsePage.aspx?id=ZOrjoRGHW0a27251DWrQb7SjwJ0Q6f1Dm73UP8eB77pUM0FHOFpGMFhRUlVXOFNaU0QxNzJVU0xUWi4u&embed=true";
      break;
    case "sanatayn":
      whichClassTitle = "Online Sanatayn Course for Sisters";
      iframeUrl =
        "https://forms.cloud.microsoft/Pages/ResponsePage.aspx?id=Q1sH_SUfqkaLxul0jq9syeD8k54sSshHudLQ7gjCZlRUNzhOOVVDUkI5MDdVNEVZSFk1OU5YRkkyVy4u";
      break;
    default:
      return notFound();
  }
