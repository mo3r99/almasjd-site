import Button from "@/old/app/ui/button/button";
...
const almasjid = (
  <section className="mt-4 max-w-5xl bg-[rgb(230,249,244)] p-10 smd:rounded-3xl flex flex-col smd:flex-row gap-10 text-center smd:text-right">
    <Image
      src={
        "//wsrv.nl/?url=almasjid-site.s3.eu-north-1.amazonaws.com/ottoman.png&w=450&h=450"
      }
      unoptimized
      width={400}
      height={200}
    ...
    <Image
      src={
        "//wsrv.nl/?url=almasjid-site.s3.eu-north-1.amazonaws.com/ottoman.png&w=300&h=300"
      }
      unoptimized
      width={200}
      height={150}
    ...
    <div>
      ...
      <Heading className="text-[1.5rem] leading-8 smd:text-4xl">
        Abu Hurayra (May Allāh be pleased with him) narrates that the Messenger
        of Allāh ﷺ said: “Allāh says: ‘Spend, O son of Adam, and I shall spend
        on you.'”
      </Heading>
      <p className="font-[family-name:var(--font-montserrat)] mt-4">
        ...
        to our cause, you are taking part in this noble mission and are
        investing in Sadaqah Jariyah for yourself.
      </p>
      <Button
        colour={"orange"}
        href={"/support-almasjid"}
        className={"max-w-72 mt-4 mx-auto justify-center smd:float-right"}
      >
        Support Al Masjid
      </Button>
    </div>
...
const sadqah = (
  <section className="smd:mb-8 flex flex-col smd:flex-row-reverse gap-6 smd:mt-4 max-w-5xl text-center smd:text-left bg-[rgb(249,243,230)] p-8 smd:p-10 smd:rounded-3xl">
    <Image
      src={
        "//wsrv.nl/?url=almasjid-site.s3.eu-north-1.amazonaws.com/charity-hand.png&w=291&h=350"
      }
      unoptimized
      width={350}
      height={200}
    ...
    <Image
      src={
        "//wsrv.nl/?url=almasjid-site.s3.eu-north-1.amazonaws.com/charity-hand.png&w=200&h=250"
      }
      unoptimized
      width={200}
      height={200}
    ...
    <div>
      ...
      <Heading className="text-[1.5rem] leading-8 smd:text-4xl">
        ...
        another except that Allah increases his honour, and no one humbles
        himself for the sake of Allah except that Allah raises his status."
      </Heading>
      <p className="font-[family-name:var(--font-montserrat)] mt-4">
        The Prophet ﷺ said: “The believer’s shade on the Day of Resurrection
        will be his Sadaqah.” (Al-Tirmidhi).
      </p>
      <Button
        colour={"blue"}
        href={"/sadaqah"}
        className={
          "max-w-72 mt-4 justify-center mx-auto smd:float-left smd:justify-start"
        }
      >
        Give Sadaqah
      </Button>
