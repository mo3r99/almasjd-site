...
import links from "@/old/app/lib/links";
    ...
    >
      <div className="md:col-span-2">
        ...
        <div className="font-[family-name:var(--font-montserrat)] pb-4">
          ...
          >
            <Image
              src={
                "https://almasjid-site.s3.eu-north-1.amazonaws.com/small-green-landscape.png"
              }
              width={250}
              height={87.5}
              unoptimized
      ...
      <div className="md:col-span-1">
        ...
        <ul className="flex mb-4">
          ...
          <a
            target="_blank"
            href={"https://whatsapp.com/channel/0029VaxQMtW6LwHl1qEtBY0x"}
          >
            <Image
              className="mx-1 w-auto h-auto invert"
              src={
                "https://almasjid-site.s3.eu-north-1.amazonaws.com/Whatsapp.png"
              }
              width={30}
              height={30}
              alt="WhatsApp"
