...
const placeholder = "almasjid-site.s3.eu-north-1.amazonaws.com/placeholder.png";
    ...
    >
      <div className="w-full aspect-[3/2] mb-4 relative">
        <Image
          ...
          src={
            image
              ? `//wsrv.nl/?url=${image}&w=300&h=300`
              : `//wsrv.nl/?url=${placeholder}&w=300&h=300`
          }
          // style={{
          //   clipPath:
      ...
      <div className="mb-2">
        {newCourse && (
          <span className="font-[family-name:var(--font-montserrat)] bg-weborange p-1 rounded-md text-xs text-white uppercase mr-2">
            New
          </span>
        )}
        {applicationsOpen && (
          <span className="font-[family-name:var(--font-montserrat)] bg-weborange p-1 rounded-md text-xs text-white uppercase">
            Applications Open
          </span>
        )}
      </div>
